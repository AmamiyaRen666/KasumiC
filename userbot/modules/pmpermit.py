        ...
        if not apprv and event.text != UNAPPROVED_MSG:
            ...
            if COUNT_PM[event.chat_id] > 4:
                ...
                try:
                    ...
                    return LOGS.info("CountPM tidak diretas boi")
...
async def notifon(non_event):
    ...
    await non_event.edit("`Pemberitahuan dari PM yang tidak disetujui disuarakan!`")
...
async def approvepm(apprvpm):
    ...
    try:
        ...
        return await apprvpm.edit("`disetujui untuk PM!`")

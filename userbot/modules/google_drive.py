    ...
    if G_DRIVE_DATA is not None:
        ...
        try:
            ...
            await gdrive.edit(
                ...
                "`Reason` : **G_DRIVE_DATA** entitas tidak valid!"
        ...
        if G_DRIVE_CLIENT_ID is None and G_DRIVE_CLIENT_SECRET is None:
            ...
            await gdrive.edit(
                ...
                "`Reason` : tolong ambil **G_DRIVE_DATA** "

                "[sini](https://telegra.ph/How-To-Setup-Google-Drive-04-03)"
...
async def upload(gdrive, service, file_path, file_name, mimeType):
    ...
    body = {
        ...
        "description": "Diupload dari Telegram menggunakan KasumiC userbot.",
...
async def lists(gdrive):
    ...
    if checker is not None:
        ...
        if page_size > 1000:
            ...
            await gdrive.edit(
                ...
                "`Reason` : tidak bisa mendapatkan daftar jika batas lebih dari 1000."
    ...
    if len(message) > 4096:
        ...
        with open("result.txt", "w") as r:
            ...
            r.write(f"Google Drive Pertanyaan:\n{query}\n\nHasil\n\n{message}")
    ...
    for name_or_id in f_name:
        ...
        if exe == "mkdir":
            ...
            if mimeType == "application/vnd.google-apps.folder":
                ...
                status = "[FOLDER - TERHAPUS]"

            else:

                status = "[FILE - TERHAPUS]"
...
async def google_drive(gdrive):
    ...
    if not value and not gdrive.reply_to_msg_id:
        ...
        await gdrive.edit(
            ...
            "`Reason` : Bingung mengupload file atau membalas message/media."
    ...
    try:
        ...
        if True in [c1 or c2]:
            ...
            await gdrive.edit(
                ...
                "`[PARENT - FOLDER]`\n\n" "`Status` : **WARNING** - memaksa menggunakan..."
        ...
        if "uc?id=" in ext_id:
            ...
            await gdrive.edit(
                ...
                "`[URL - ERROR]`\n\n" "`Status` : **BAD** - Tidak valid folderURL."
            ...
            if " depth exceeded" in str(e):
                ...
                try:
                    ...
                    await gdrive.edit(
                        ...
                        "`Reason` : Download otomatis dibatalkan, URI/Torrent mati."
